	...
	class BoxedPhys {
		...
		getInfo() {
			return {
				...
				menus: {
					sceneType:{ items:['semi-closed stage', 'boxed stage', 'opened stage', 'nothing'],
							   acceptReporters: true,
							  },
					BodyTypePK:{ items:['dynamic', 'static', 'kinematic', 'fixed with rotation'],
								acceptReporters: true,
							   },
					BodyTypePK2:{ items:['dynamic', 'static', 'any'],
								 acceptReporters: true,
								},
					bodyAttr:{ items:['damping', 'rotational damping'],
							  acceptReporters: true,
							 },
					bodyAttrRead:{ items:['x', 'y', 'Xvel', 'Yvel', 'Dvel', 'direction', 'awake', 'type', 'friction', 'pressure'],
								  acceptReporters: true,
								 },
					ForceType:{ items:['Impulse', 'World Impulse'],
							   acceptReporters: true,
							  },
					AngForceType:{ items:['Impulse'],
								  acceptReporters: true,
								 },
					JointType:{ items:['Rotating', 'Spring', 'Weld', 'Slider'],
							   acceptReporters: true,
							  },

					
					JointAttr:{ items:['Motor On', 'Motor Speed', 'Max Torque', 'Limits On', 'Lower Limit', 'Upper Limit'],
							   acceptReporters: true,
							  },
					JointAttrRead:{ items:['Angle', 'Speed', 'Motor Torque', 'Reaction Torque', 'tension'],
								   acceptReporters: true,
								  },
					xyp:{ items:['x', 'y', 'point'],
						 acceptReporters: true,
